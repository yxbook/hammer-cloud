...
public class SensitiveWordTest {
    ...
    //敏感词库文件路径
    public static String filePath = SensitiveWordTest.class.getClassLoader().getResource("CensorWords.txt").getPath();
    public static Set<String> words;
    public static Map<String,String> wordMap;
    public static int minMatchTYpe = 1;      //最小匹配规则
    public static int maxMatchType = 2;      //最大匹配规则
    static{
        SensitiveWordTest.words = readTxtByLine(filePath);
        addBadWordToHashMap(SensitiveWordTest.words);
    }
